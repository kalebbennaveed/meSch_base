...
class meSchBaseNode(Node):
    ...
    def __init__(self):
        ...
        self.quad_objects = [
            QuadObj("px4_102", 0, "Grounded", 120.0, True, 0, px4_102_int_soc, 0.0, False),
        ]
        ...
        self.pub_meSch_vec = np.array([self.pub_px4_102_meSch])
    ...
    def px4_102_meSch_cb(self, px4_102_meSch_msg):
        self.quad_objects[0].quad_name = px4_102_meSch_msg.quad_name
        self.quad_objects[0].cand_id = px4_102_meSch_msg.cand_id
        self.quad_objects[0].remaining_flight_time = px4_102_meSch_msg.remaining_flight_time
        self.quad_objects[0].precomp_done = px4_102_meSch_msg.precomp_done
        self.quad_objects[0].mission = px4_102_meSch_msg.mission
