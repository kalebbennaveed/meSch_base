...
class meSchBaseNode(Node):
    ...
    def __init__(self):
        ...
        self.get_logger().info("Initializing meSch-mobile base node")
    ...
    def mission_status_cb(self, mission_status_msg):
        ...
        if (mission_status_msg.mission_start == False) and (mission_status_msg.mission_quit == False) and (self.precomp_done == False):
            ...
            self.precomp_done = (self.quad_objects[0].precomp_done and self.quad_objects[1].precomp_done)
    ...
    def stop_timers(self):
        ...
        # Publish to the Quad to start the setpoint node
        self.pub_px4_100_meSch.publish(self.px4_100_BaseToQuadMesch)
        self.pub_px4_101_meSch.publish(self.px4_100_BaseToQuadMesch)
    ...
    def ComTraj_callback(self):
        ...
        pos_d, vel_d, acc_d, phi_d = figure_eight(curr_time + 10.0)
        ...
        for i in self.active_quads:
            ...
            if i == 0:
                ...
                # Update the charging position
                self.px4_100_BaseToQuadMesch.charge_position[0] = pos_d[0]
                self.px4_100_BaseToQuadMesch.charge_position[1] = pos_d[1]
                self.px4_100_BaseToQuadMesch.charge_position[2] = pos_d[2]
            ...
            if i == 1:
                ...
                # Update the charging position
                self.px4_101_BaseToQuadMesch.charge_position[0] = pos_d[0]
                self.px4_101_BaseToQuadMesch.charge_position[1] = pos_d[1]
                self.px4_101_BaseToQuadMesch.charge_position[2] = pos_d[2]
                self.pub_px4_101_meSch.publish(self.px4_101_BaseToQuadMesch)
                self.evaluate_candidate_trajs = True
